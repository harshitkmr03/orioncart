...
public class DiscoveryService {
    ...
    public List<Map<String, Object>> findNearby(double lat, double lng, double radiusMeters) {
        List<com.orioncart.dto.ShopDistance> rows = shopRepository.findNearby(lat, lng, radiusMeters);
        List<Map<String, Object>> out = new ArrayList<>();
        for (com.orioncart.dto.ShopDistance r : rows) {
     ...
     */
    public List<com.orioncart.dto.ShopDistance> findNearbyProjection(double lat, double lng, double radiusMeters) {
