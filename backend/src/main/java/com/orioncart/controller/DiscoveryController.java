...
public class DiscoveryController {
    ...
    @GetMapping("/dto")
    public ResponseEntity<List<com.orioncart.dto.ShopDistance>> findNearbyDto(
            @RequestParam double lat,
            @RequestParam double lng,
            @RequestParam(defaultValue = "5000") int radiusMeters
    ) {
        ...
        List<com.orioncart.dto.ShopDistance> results = discoveryService.findNearbyProjection(lat, lng, radiusMeters);
        return ResponseEntity.ok(results);
    }
}
