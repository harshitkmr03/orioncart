...
import com.localconnect.backend.dto.DisputeRequest;
import com.localconnect.backend.dto.DisputeResponse;
...
import com.localconnect.backend.repository.DisputeRepository;
import com.localconnect.backend.repository.OrderRepository;
...
public class DisputeService {
    ...
    public DisputeResponse createDispute(Long customerId, DisputeRequest request) {
        ...
        dispute.setEvidenceImageUrls(joinEvidence(request.getEvidenceImageUrls()));
    ...
    private DisputeResponse toResponse(Dispute dispute) {
        return new DisputeResponse(
                ...
                splitEvidence(dispute.getEvidenceImageUrls()),
                dispute.getStatus(),
