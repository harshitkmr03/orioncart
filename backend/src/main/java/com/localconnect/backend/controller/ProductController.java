...
import com.localconnect.backend.dto.ProductBulkUploadResult;
import com.localconnect.backend.dto.QuickStockUpdateRequest;
import com.localconnect.backend.model.Product;
import com.localconnect.backend.service.DiscoveryService;
import com.localconnect.backend.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<byte[]> downloadCsvTemplate() {
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=localconnect-product-template.csv")
